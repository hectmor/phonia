...
mod tests {
    ...
    /// What the decoder must produce for `sample_at(i)`: left-justified in an `i32`.
    fn expected(from_sample: usize, to_sample: usize) -> Vec<i32> {
